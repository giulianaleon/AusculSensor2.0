                      ...
                      children: [
                        ...
                        IconButton(
                          onPressed: () {
                           ...
                           // player.play('somtraqueal.mp3');  //ARRUMAR AQUI
                          },
                    ...
                    child: Column(
                      children: [
                        ...
                        IconButton(
                          onPressed: () {
                            final player = AudioCache();
                            // player.play('sombronquico.mp3');   //ARRUMAR AQUI
                          },
                          icon: const Icon (Icons.play_circle_filled),
                          iconSize: 35,
                        ),
                    ...
                    child: Column(
                      children: [
                        ...
                        IconButton(
                          onPressed: (){
                            final player = AudioCache();
                            //player.play('sombroncovesicular.mp3');   //ARRUMAR AQUI
                          },
                          icon: const Icon (Icons.play_circle_filled),
                          iconSize: 35,
                        ),
                    ...
                    child: Column(
                      children: [
                        ...
                        IconButton(
                            onPressed: () {
                              final player = AudioCache();
                              //player.play('murmuriovesicular.mp3');  //ARRUMAR AQUI
                            },
                          icon: const Icon (Icons.play_circle_filled),
                          iconSize: 35,
                        ),
                        ...
                        IconButton(
                          onPressed: () {
                            final player = AudioCache();
                            //player.play('vesiculares5.mp3');   //ARRUMAR AQUI
                          },
                          icon: const Icon (Icons.play_circle_filled),
                          iconSize: 35,
                        ),
