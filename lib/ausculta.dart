...
class _Ausculta extends State<HomePage> {
  ...
  late List<double> traceDust;


  late List item;
  late String nomeSelecionado;

  late List itemProfissional;
  late String nomeSelecionadoProfissional;

  late String testeValor;
                            ...
                            child: Column(
                              children:   [
                                ...
                                DropdownButton(
                                  ...
                                  items: item.map((list){
                                    return DropdownMenuItem(
                                      ...
                                      value: list['nome'] as String,
                                    );
                                  },).toList(),
                                  onChanged: (value){
                                    setState(() {
                                      nomeSelecionado = value as String;
                                    });
                                  },
                                ),
                                ...
                                DropdownButton(
                                  ...
                                  onChanged: (value){
                                    setState(() {
                                      nomeSelecionadoProfissional = value as String;
                                    });
                                  },
                                ),
